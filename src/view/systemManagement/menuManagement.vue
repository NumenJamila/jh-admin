  ...
  data () {
    ...
    return {
      ...
      columns: [
            ...
            return h('div', [
              h(
                'a',
                {
                  ...
                  on: {
                    click: () => {
                      this.addTwoMenu(params.row.id, params.row.level, params.row.menuCode)
                    }
                  }
                },
                params.row.name
        ...
        { title: '路由级别', key: 'level', align: 'center', width: '100', sortable: true },
        {
          title: '操作',
          align: 'center',
          key: 'action',
        ...
        if (valid) {
          if (!this.formItem.id || this.formItem.id === undefined) {
            if (this.formItem.parentId === 0) {
              ...
              this.formItem.menuCode = this.formItem.parentCode + ':' + this.formItem.menuUrl
            }
